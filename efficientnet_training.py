...
callbacks = [
    ...
    ModelCheckpoint(
        "colored_pathogen_efficientnet.h5",
...
model.save("colored_pathogen_classifier_efficientnet.h5")
print("Model saved as colored_pathogen_classifier_efficientnet.h5")
